...
public class Arrays_01 {
	...
	public static void main(String[] args) {
		...
		String takim[] = new String[7];              // [null, null, null, null, null, null, null]
		System.out.println(Arrays.toString(takim));
		
		takim[0]="Ali";
		System.out.println(Arrays.toString(takim));  // [Ali, null, null, null, null, null, null]
		takim[2]="Hasan";
		takim[1]="Veli";
		System.out.println(Arrays.toString(takim));  // [Ali, Veli, Hasan, null, null, null, null]
		...
		takim[1] ="Kemal";
		System.out.println(Arrays.toString(takim)); // [Ali, Kemal, Hasan, null, null, null, null]
		...
		System.out.println(Arrays.toString(takim));  // [Ali, Kemal, Hasan, null, null, null, Mehmet]
		...
		if (takim.length %2 ==1) {
		 ...
		 System.out.println(Arrays.toString(takim));  // [Ali, Kemal, Hasan, Can, null, null, Mehmet]
