...
public class C5_ArtırmaAzaltma {
	...
	public static void main(String[] args) {
		...
		num = num+5; // esitligin solunda num yazdigimizda esitligin sagindaki islemde olusan sonuc num 
					 // num variable'ina atanir. bu satirdan SONRA num=20 dir. 2. atama
		
		             // ne içn ınt yazmadık? yazarsak java itiraz eder.çünkü 7. satırda 1 kez tanımladık
                     // bir daha tanımlamaya gerek yok.
