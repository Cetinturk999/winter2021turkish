...
public class Scope6 {
	...
	public int num1;     // access modifier public yapýlýnca heryerden ulasýlabilir
	String name = "Ali"; // access modifier yazýlmadýðý icin default a   m gecerlidir
	                     // sadece paket icinde kullanýlýr
