...
public class Scope1 {
	...
	public int sayi; // default deger "0" 'dýr.

	// class'in icinde fakat main method'un disinda olusturulan
	...
	public void method() {
		System.out.println(sayi); // bu method static olmadýðý için instance variable'lara direk eriþebilir
		sayi = sayi + 20; //
