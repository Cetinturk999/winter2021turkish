...
public class Inheritance01 {
	...
	public static void main(String[] args) {
		...
		// isim. yAZINCA BÝRSÜRÜ METHOD GELÝYOR. NASIL GELÝYOR?
		// Java arkadan biz class olusturdugumuzda o yapýyý tamamen olusturuyor
		// biz farkýnda olmadan bu zaman kadar Inheritance yi kullandýk
		
		// obje  her class'ýmýzýn buyuk buyuk babasýdýr.
		
		// private datalar inheritance olmaz
